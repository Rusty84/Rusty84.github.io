...
Poor goals will produce poor tests.

So what makes a good goal?

<h3>1. Focus on the Outcome, Not the Journey</h3>
...
<h3>3. Avoid Describing Today's UI</h3>

One of the biggest advantages of agentic testing is that it isn't tied to a rigid sequence of 
UI interactions.
...
<h3>4. Make Success Easy to Measure</h3>
...
This is something Google's Firebase App Testing agent does particularly well. Alongside the goal, you can provide hints
and success criteria to help the agent understand when it has actually ahieved the objective.
...
Success Criteria:
The Home screen is displayed, and the user profile name is visible.
```
That's clearer than simply saying "test the login screen".

<h3>5. Think Like Your Users</h3>
...
<h3>A Good Goal Doesn't Mean Less Testing</h3>
